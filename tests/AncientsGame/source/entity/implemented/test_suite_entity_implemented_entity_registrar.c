...
#warning Please make tests for: AncientsGame/source/entity/implemented/test_suite_entity_implemented_entity_registrar.c

// Before writing any tests, please see the README
// found in ./tests

DEFINE_SUITE(entity_registrar, END_TESTS)
